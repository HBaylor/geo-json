let Utils = (function () {
  ...
  function compareDate (date1, date2) {
    ...
    let dateTime2 =
      date2 instanceof Date ? date2.getTime() : /^(\+|-)?\d+($|\.\d+$)/.test(date2) ? date2 : new Date(date2).getTime()
  ...
  function dateDiff (date1, date2) {
    ...
    let dateTime1 =
      date1 instanceof Date ? date1.getTime() : /^(\+|-)?\d+($|\.\d+$)/.test(date1) ? date1 : new Date(date1).getTime()
    let dateTime2 =
      date2 instanceof Date ? date2.getTime() : /^(\+|-)?\d+($|\.\d+$)/.test(date2) ? date2 : new Date(date2).getTime()
